...
function transformSchema(schema, transformType) {
  ...
  return new graphql_1.GraphQLSchema(
    Object.assign(Object.assign({}, schemaConfig), {
  ...
  function replaceFields(fieldsMap) {
    return apollo_env_1.mapValues(fieldsMap, field =>
  ...
  function replaceInputFields(fieldsMap) {
    return apollo_env_1.mapValues(fieldsMap, field =>
      Object.assign(Object.assign({}, field), { type: replaceType(field.type) })
    );
  }
  function replaceArgs(args) {
    return apollo_env_1.mapValues(args, arg =>
      Object.assign(Object.assign({}, arg), { type: replaceType(arg.type) })
    );
  }
}
