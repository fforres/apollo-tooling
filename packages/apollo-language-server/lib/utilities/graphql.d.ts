...
export declare function isDirectiveDefinitionNode(
  node: ASTNode
...
export declare function removeDirectives<AST extends ASTNode>(
  ast: AST,
  directiveNames: string[]
): AST;
export declare function removeDirectiveAnnotatedFields<AST extends ASTNode>(
  ast: AST,
  directiveNames: string[]
): AST;
export declare function withTypenameFieldAddedWhereNeeded(ast: ASTNode): any;
export declare function simpleCollectFields(
  context: ExecutionContext,
  selectionSet: SelectionSetNode,
  fields: Record<string, FieldNode[]>,
  visitedFragmentNames: Record<string, boolean>
): Record<string, FieldNode[]>;
export declare function hasClientDirective(
