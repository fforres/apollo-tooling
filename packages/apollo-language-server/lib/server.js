...
const whenConnectionInitialized = new Promise(
  resolve => (initializeConnection = resolve)
);
const workspace = new workspace_1.GraphQLWorkspace(
  new loadingHandler_1.LanguageServerLoadingHandler(connection),
  {
    clientIdentity: {
...
documents.onDidChangeContent(
  utilities_1.debounceHandler(params => {
...
const languageProvider = new languageProvider_1.GraphQLLanguageProvider(
  workspace
);
...
connection.onCompletion(
  utilities_1.debounceHandler((params, token) =>
...
connection.onNotification("apollographql/tagSelected", selection =>
