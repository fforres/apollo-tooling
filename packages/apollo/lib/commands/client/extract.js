      ...
      ({ flags, project, config, args }) => [
        {
          ...
          task: async ctx => {
            ctx.operations = getOperationManifestFromProject_1.getOperationManifestFromProject(
              this.project,
              {
        ...
        },
        {
          ...
          task: (ctx, task) => {
            ...
            fs_1.writeFileSync(
              filename,
              JSON.stringify(
                { version: 2, operations: ctx.operations },
                null,
                2
              )
            );
...
ClientExtract.flags = Object.assign(
  Object.assign({}, Command_1.ClientCommand.flags),
  {
    preserveStringAndNumericLiterals: command_1.flags.boolean({
      description:
