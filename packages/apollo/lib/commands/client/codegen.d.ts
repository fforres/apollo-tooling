...
export default class Generate extends ClientCommand {
  ...
  static flags: {
    ...
    passthroughCustomScalars: import("@oclif/parser/lib/flags").IBooleanFlag<
      boolean
    >;
    customScalarsPrefix: flags.IOptionFlag<string | undefined>;
    mergeInFieldsFromFragmentSpreads: import("@oclif/parser/lib/flags").IBooleanFlag<
      boolean
    >;
    namespace: flags.IOptionFlag<string | undefined>;
    omitDeprecatedEnumCases: import("@oclif/parser/lib/flags").IBooleanFlag<
      boolean
    >;
    operationIdsPath: flags.IOptionFlag<string | undefined>;
    only: flags.IOptionFlag<string | undefined>;
    suppressSwiftMultilineStringLiterals: import("@oclif/parser/lib/flags").IBooleanFlag<
      boolean
    >;
    useFlowExactObjects: import("@oclif/parser/lib/flags").IBooleanFlag<
      boolean
    >;
    useFlowReadOnlyTypes: import("@oclif/parser/lib/flags").IBooleanFlag<
      boolean
    >;
