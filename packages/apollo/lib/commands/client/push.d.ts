...
export default class ClientPush extends ClientCommand {
  ...
  static flags: {
    clientReferenceId: import("@oclif/command/lib/flags").IOptionFlag<
      string | undefined
    >;
    clientName: import("@oclif/command/lib/flags").IOptionFlag<
      string | undefined
    >;
    clientVersion: import("@oclif/command/lib/flags").IOptionFlag<
      string | undefined
    >;
    ...
    includes: import("@oclif/command/lib/flags").IOptionFlag<
      string | undefined
    >;
    excludes: import("@oclif/command/lib/flags").IOptionFlag<
      string | undefined
    >;
    ...
    endpoint: import("@oclif/command/lib/flags").IOptionFlag<
      string | undefined
    >;
