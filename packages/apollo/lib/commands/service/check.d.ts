...
export declare function formatCompositionErrorsMarkdown({
  compositionErrors,
  graphName,
  serviceName,
  tag
...
export declare function formatHumanReadable({
  checkSchemaResult,
  graphCompositionID
}: {
  checkSchemaResult: CheckSchema_service_checkSchema;
...
export default class ServiceCheck extends ProjectCommand {
  ...
  static flags: {
    ...
    queryCountThreshold: import("@oclif/parser/lib/flags").IOptionFlag<
      number | undefined
    >;
    queryCountThresholdPercentage: import("@oclif/parser/lib/flags").IOptionFlag<
      number | undefined
    >;
